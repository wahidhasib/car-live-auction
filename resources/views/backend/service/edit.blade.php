                    ...
                    <form action="{{ route('admin.service.update', $service->id) }}" method="POST"
                        ...
                        <div class="row">
                            <div class="form-group mt-2 col-sm-6">
                                ...
                                <input type="text" value="{{ $service->service_title }}" placeholder="Service Title..."
                            ...
                            <div class="form-group mt-2 col-sm-6">
                                ...
                                <input type="text" value="{{ $service->service_icon }}" placeholder="" id="service_icon"
                            ...
                            <div class="form-group mt-2 col-sm-6">
                                ...
                                <input type="text" placeholder="Service short text..."
                            ...
                            <div class="form-group mt-2 col-sm-12">
                                ...
                                <textarea name="service_description" id="service_description" placeholder="Service full description"
                                    class="form-control @error('service_description') is-invalid @enderror">{{ $service->service_description }}</textarea>
                            ...
                            <div class="form-group mt-2 col-sm-6">
                                ...
                                <input type="text" value="{{ $service->meta_title }}"
                                    placeholder="Meta title for SEO..." id="meta_title"
                            ...
                            <div class="form-group mt-2 col-sm-6">
                                ...
                                <textarea name="meta_description" id="meta_description" placeholder="Meta description for SEO"
                                    class="form-control @error('meta_description') is-invalid @enderror">{{ $service->meta_description }}</textarea>
